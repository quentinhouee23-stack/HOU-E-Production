...
import React, { useEffect, useState, useRef } from "react"; // 🟢 useRef est bien de retour !
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#121212] text-white overflow-x-hidden pb-32">
      ...
      <AnimatePresence mode="wait">
        {!selectedAlbum ? (
          <motion.div 
            ...
            animate={{ opacity: 1 }} 
            exit={{ opacity: 0, x: -50 }}
            className="px-4 sm:px-6 pt-28 space-y-10 max-w-5xl mx-auto"
          >
          ...
          <motion.div 
            ...
            className="px-4 sm:px-6 pt-28 max-w-5xl mx-auto"
          >
            <button onClick={() => {
              setSelectedAlbum(null);
              if (previewAudioRef.current) previewAudioRef.current.pause();
            ...
            <div className="mb-8 pl-4">
               <button 
                 ...
                 className="w-14 h-14 flex items-center justify-center rounded-full bg-[#1db954] text-black hover:scale-105 transition-transform shadow-xl pl-1"
               >
